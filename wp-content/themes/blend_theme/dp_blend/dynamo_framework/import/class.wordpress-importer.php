...
class WP_Import extends WP_Importer {
	...
	function import_end() {
		...
		echo '<p>' . __( 'All done.', 'wordpress-importer' ) . ' <a href="' . network_admin_url() . '">' . __( 'Have fun!', 'wordpress-importer' ) . '</a>' . '</p>';
	...
	function import_options() {
		$j = 0;
?>
<form action="<?php echo network_admin_url( 'admin.php?import=wordpress&amp;step=2' ); ?>" method="post">
