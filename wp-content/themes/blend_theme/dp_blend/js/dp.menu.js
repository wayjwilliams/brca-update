...
jQuery(document).ready(function(){
	...
	jQuery('.dp-mainmenu-toggle').click(function(){
	jQuery('#dp-page-box').toggleClass('is-mobile-menu');
	jQuery('#dp-mobile-menu').toggleClass('is-mobile-menu');
...
jQuery(window).resize(function () {
	...
	if(typeof $DP_TABLET_WIDTH != 'undefined') {
		if (jQuery(window).width()> $DP_TABLET_WIDTH) {
		   jQuery('#dp-page-box').removeClass('is-mobile-menu');
			jQuery('#dp-mobile-menu').removeClass('is-mobile-menu');
