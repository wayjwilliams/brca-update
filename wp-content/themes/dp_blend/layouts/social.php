...
?>
	...
	<?php if(get_option($dynamo_tpl->name . '_fb_like', 'Y') == 'Y') : ?>
	<div id="fb-root"></div>
	<script type="text/javascript">
	//<![CDATA[     
	      window.fbAsyncInit = function() {
	        FB.init({
	          appId      : '<?php echo get_option($dynamo_tpl->name . '_fb_api_id', ''); ?>', // App ID
	      ...
	      (function(d){
	         ...
	         js.src = "//connect.facebook.net/<?php echo get_option($dynamo_tpl->name . '_fb_lang', 'en_US'); ?>/all.js";
	...
	<?php if(get_option($dynamo_tpl->name . '_tweet_btn', 'Y') == 'Y') : ?>
	<script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
	<?php endif; ?>
	
	<?php if(get_option($dynamo_tpl->name . '_google_plus', 'Y') == 'Y') : ?>
	<script type="text/javascript" src="https://apis.google.com/js/plusone.js">
	  {lang: '<?php echo get_option($dynamo_tpl->name . "_google_plus_lang", "en-GB"); ?>'}
	</script>
	<?php endif; ?>
	
	<?php if(get_option($dynamo_tpl->name . '_pinterest_btn', 'Y') == 'Y') : ?>
