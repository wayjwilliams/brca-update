...
include_once(dynamo_file('dynamo_framework/classes/class.menu.walker.dotnav.php'));
...
class DynamoWP {
	 ...
	 **/
	 ...
	 private function add_features() {
		...
		add_image_size('portfolio-horizontal', 640,480, true);
		add_image_size('portfolio-square', 640, 640, true);
		add_image_size('portfolio-vertical', 640, 850, true);
